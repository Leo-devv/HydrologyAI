        ...
        <TabsContent value="slider">
          <div className="relative h-[400px] w-full overflow-hidden border rounded-md bg-slate-100">
            <div className="relative h-full w-full" style={{ transform: `scale(${zoomLevel})`, transformOrigin: 'center' }}>
              ...
              {/* Slider overlay (2030) */}
              <div className="absolute inset-0 overflow-hidden" style={{ width: `${overlayOpacity * 100}%` }}>
                <img
                  src={afterImage}
                  alt="Projected 2030"
                  className="absolute inset-0 w-full h-full object-contain"
                  style={{ width: '100vw' }}  // Ensure full width coverage
                />
                <div className="absolute inset-y-0 right-0 w-1 bg-white shadow-lg"></div>
              </div>
