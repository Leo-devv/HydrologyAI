...
export default function App() {
  const [date, setDate] = useState<Date>(new Date(2023, 7, 15)) // August 15, 2023
  const [compareDate, setCompareDate] = useState<Date>(new Date(2018, 7, 15)) // August 15, 2018
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      <div className="flex flex-col">
                        ...
                        <DatePickerWithPresets date={compareDate} setDate={setCompareDate} />
                      </div>
                      <div className="flex flex-col">
